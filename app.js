...
res.render('home.hbs',{
	pageTitle:'Home Page',
	welcomeMessage:'Name:Divyani kuamri',
	welcomeMessage1:'Registration no :11610158',
...
app.get('/exam',(req,res)=>{
	...
	app.get('/self',(req,res)=>{
		res.render('selfe.hbs',{
			pageTitle:'Self Details',
			welcomeMessage:'Self Details of Student',
